...
export const sendOTPEmail = async (email, otp) => {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Password Reset OTP - Murugan Mart',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; text-align: center;">
            <h1 style="color: white; margin: 0;">Murugan Mart</h1>
          </div>
          ...
          <div style="padding: 30px; background: #f9f9f9;">
            ...
            <div style="background: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; border-radius: 5px; margin: 20px 0;">
              <p style="color: #856404; margin: 0;">
                <strong>Security Tip:</strong> Never share this OTP with anyone. Murugan Mart will never ask for your OTP via phone or email.
              </p>
            </div>
          </div>
          
          <div style="background: #333; color: white; padding: 20px; text-align: center;">
            <p style="margin: 0;">© 2024 Murugan Mart. All rights reserved.</p>
          </div>
        </div>
      `,
    };
...
export const sendWelcomeEmail = async (email, firstName) => {
  try {
    ...
    const mailOptions = {
      from: process.env.EMAIL_USER,
      to: email,
      subject: 'Welcome to Murugan Mart!',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 20px; text-align: center;">
            <h1 style="color: white; margin: 0;">Murugan Mart</h1>
          ...
          <div style="padding: 30px; background: #f9f9f9;">
            ...
            <p style="color: #666; line-height: 1.6; margin-bottom: 20px;">
              Thank you for joining Murugan Mart! Your account has been successfully created.
            </p>
