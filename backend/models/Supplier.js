...
const Supplier = sequelize.define(
    'Supplier',
    {
        ...
        PurchaseOrderReturnMode: {
            type: DataTypes.INTEGER,
            allowNull: true,
            field: 'Purchase Orderreturnmode'
        },
        PurchaseOrderReturnPercentage: {
            type: DataTypes.TEXT,
            allowNull: true,
            field: 'Purchase Orderreturnpercentage'
        },
        Calculatetaxforfree: {
            type: DataTypes.INTEGER,
            allowNull: true,
        ...
        PurchaseOrderPriceInclExiseDuty: {
            type: DataTypes.TEXT,
            allowNull: true,
            field: 'Purchase OrderPriceInclExiseDuty'
        },
