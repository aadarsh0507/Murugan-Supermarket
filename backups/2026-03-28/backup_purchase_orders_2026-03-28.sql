...
-- Date: 2026-03-28
-- Generated: 2026-03-28T17:51:16.254Z
...
-- Dumping data for table `purchase_orders` (8 rows)
...
INSERT INTO `purchase_orders` (`id`, `po_number`, `supplier_id`, `supplier_name`, `store_id`, `order_date`, `expected_delivery_date`, `total_items`, `total_quantity`, `subtotal`, `discount`, `tax`, `shipping`, `total_amount`, `partial_payment`, `is_credit`, `status`, `notes`, `created_at`, `updated_at`) VALUES (16, 'PO-MSM-006', '3', NULL, '2', '2026-02-25 00:00:00', NULL, 1, 5, '394.75', '10.00', '0.00', '0.00', '384.75', '0.00', 0, 'created', NULL, '2026-02-25 12:35:01', '2026-02-25 12:35:01');
UNLOCK TABLES;
